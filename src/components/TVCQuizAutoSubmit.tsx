...
interface TVCQuizAutoSubmitProps {
  materialId: string;
...
export interface TVCQuizAutoSubmitRef {
  forceSubmit: () => void;
}

const TVCQuizAutoSubmit = forwardRef<TVCQuizAutoSubmitRef, TVCQuizAutoSubmitProps>(
  ({ materialId, questionCount, isTimeUp, elapsedSeconds, onComplete }, ref) => {
    ...
    const submitQuiz = async (isAutoSubmit = false) => {
      ...
      try {
        ...
        toast({
          title: isAutoSubmit ? "Timp expirat - Răspunsuri trimise!" : "Răspunsuri verificate!",
    ...
    // Expose forceSubmit to parent via ref
                  ...
                  {options.map((option) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        />
                        <Label
                          htmlFor={`quiz-auto-q${index}-${option}`}
...
TVCQuizAutoSubmit.displayName = 'TVCQuizAutoSubmit';

export default TVCQuizAutoSubmit;
